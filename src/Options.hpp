...
static const std::string RESOURCE_DIR = "res_q1_master";
...
struct DefaultValue
{
   ...
   static const int EXPLOSION_SPAWN_ANIM_LEN    = 150_ms;
   static const int EXPLOSION_BURN_ANIM_LEN     = 300_ms;
   static const int EXPLOSION_DESTROY_ANIM_LEN  = 150_ms;
